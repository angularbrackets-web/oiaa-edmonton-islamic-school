...
- main:
  ...
  - text: Recent Achievement Aug 4, 2025
  - button "Go to achievement 1"
  - button "Go to achievement 2"
  - button "Go to achievement 3"
  - heading "Provincial Excellence Awards" [level=3]
  - paragraph: Recognized for outstanding Islamic education and community leadership programs
  - button "Learn More →"
